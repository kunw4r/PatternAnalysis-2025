...
Demonstrates trained ConvNeXt model usage with comprehensive evaluation

Requirements:
- Load trained model checkpoint
- Run predictions on test set
- Generate metrics (accuracy, confusion matrix, ROC curve)
- Visualise sample predictions
- Print detailed results

Usage:
    python predict.py --checkpoint checkpoints/best_model_job319944.pth --data_dir ./data/ADNI/AD_NC
"""
...
def main():
    ...
    # Resolve checkpoint path relative to script directory if not absolute
