...
### After Prediction → Temporary Storage:
```
checkpoints/
  ├── best_model_{exp_name}.pth       ← ✅ Kept temporarily (300 MB)
  ├── training_curves_{exp_name}.png  ← ✅ Kept (small)
  └── config_{exp_name}.json          ← ✅ Kept

results/
  └── test_results_{exp_name}.json    ← ✅ Kept (~10 KB)
```

### At the Very End (after all 8 experiments):
The script compares all test accuracies and keeps only the best:
```
checkpoints/
  ├── best_model_4_base_pretrained.pth  ← ✅ BEST model (82% test acc)
  ├── best_model_1_tiny_onecycle.pth    ← ❌ DELETED (76% test acc)
  ├── best_model_2_small_onecycle.pth   ← ❌ DELETED (78% test acc)
  └── ...all others deleted...

results/
  ├── test_results_*.json               ← ✅ ALL kept (all test results)
...
================================================================================
✓ Checkpoint saved: checkpoints/best_model_1_tiny_onecycle.pth (287.3 MB)
  Will keep best 1 model(s) at the end

================================================================================
✅ EXPERIMENT COMPLETE: 1_tiny_onecycle
================================================================================
...
[... After all 8 experiments finish ...]

================================================================================
KEEPING BEST 1 MODEL(S)
================================================================================

Keeping:
  ✓ 4_base_pretrained (82.13%)

Deleting:
  🗑️  1_tiny_onecycle (78.45%)
  🗑️  2_small_onecycle (79.12%)
  🗑️  3_base_onecycle (80.21%)
  🗑️  5_base_focal_aggressive (81.05%)
  🗑️  6_base_cosine_highLR (79.88%)
  🗑️  7_small_mixup (77.92%)
  🗑️  8_base_crossentropy (80.56%)
================================================================================
```
