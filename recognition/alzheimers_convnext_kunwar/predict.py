...
def save_results(results, checkpoint_info, save_dir='./results'):
    ...
    save_path = os.path.join(save_dir, f'test_results_job{job_id}.json')
...
def main():
    ...
    if args.plot_confusion:
        ...
        cm_path = os.path.join(args.save_dir, 'confusion_matrix_slice.png')
        ...
        if args.patient_level:
            cm_path = os.path.join(args.save_dir, 'confusion_matrix_patient.png')
            plot_confusion_matrix(
