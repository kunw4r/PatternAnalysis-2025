...
## Solution
**Sequential Training with Auto-Cleanup:**
1. Train experiment #1
2. Immediately predict on test set
3. Save results (JSON, ~10 KB)
4. **Delete checkpoint** (~300 MB freed!)
5. Move to experiment #2
6. Repeat...
7. At the end, keep **only the best model**

**Storage savings: ~95%** (300 MB vs 3 GB)
